      ...
      >
        ...
        <div className="pt-8 flex flex-col items-center w-full lg:w-full space-y-4 md:space-y-6 mt-4">
          ...
          <h2 className="text-sm sm:text-base md:text-lg font-normal text-[#6F9D7E] w-2/4 -mt-2 md:-mt-4">
            The food we eat, the water we drink, the air we breathe – it all
            comes from nature
          </h2>

          <div className="flex flex-wrap sm:gap-3 gap-1 justify-center mt-6 md:-mt-4">
            <button className="btn btn-accent sm:px-6 sm:py-2 rounded-lg bg-white text-[#6F9D7E]">
              Join Us
            </button>
            <button className="btn btn-accent sm:px-6 sm:py-2 rounded-lg bg-[#6F9D7E] text-[#FFE990]">
              Donate
            </button>
          </div>
          ...
          <div className="flex justify-center mt-20 gap-10 sm:mt-10 md:-mt-10 xl:gap-14">
            ...
            >
              <Image
                ...
                width={192}
                height={160}
                className="w-32 h-20 sm:w-32 sm:h-28 md:w-48 md:h-40 lg:h-56 object-cover rounded-2xl"
              />
              <Image
                src="/farm-pic.jpg"
                alt="farm pic"
            ...
            >
              ...
              <Image
                ...
                width={192}
                height={160}
                className="w-32 h-20 object-cover sm:w-32 sm:h-28 md:w-48 md:h-40 lg:h-56 rounded-2xl"
              />
            </div>
          </div>
        </div>
