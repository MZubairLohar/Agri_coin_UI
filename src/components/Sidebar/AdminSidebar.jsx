...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        children: [
          {
            label: "All Pre Harvest Requests",
            route: "/admindashboard/allrequest/preharvest",
          },
          {
            label: "All Post Harvest Request",
...
const Adminsidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed z-20 left-0 top-0 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#6F9D7E] duration-300 ease-linear lg:translate-x-0 ${
