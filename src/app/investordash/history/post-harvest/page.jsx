      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center p-6 border-b border-gray-100">
          <h2 className="text-xl font-semibold text-gray-800 mb-4 md:mb-0">
            Post-Harvest Investment History
          </h2>
          <button
            onClick={refreshData}
            disabled={loading}
        ...
        {loading ? (
          <div className="p-12 text-center">
            ...
            <p className="mt-4 text-gray-500">
              Loading your post-harvest investments...
            </p>
          </div>
        ) : error ? (
          <div className="p-12 text-center">
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-gray-500">No post-harvest investments found.</p>
            <p className="text-gray-400 text-sm mt-1">
              Your post-harvest investments will appear here once you make them.
            </p>
          </div>
        ) : (
...
export default HistorypostHarvest;