  ...
  return (
    <FarmerLayout>
      <div className="p-6 text-[#FFE990]">
        <h1 className="text-3xl font-bold text-black mb-4">Post-Harvest Overview of History</h1>
      ...
      <div className="p-6 bg-[#6F9D7E] w-11/12 max-w-6xl mx-auto text-black border border-[#FFE990] rounded-lg shadow">
