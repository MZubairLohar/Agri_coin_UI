          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block mb-2">Investment Type Needed (Select all that apply)</label>
                        ...
                        <label key={source} className="flex items-center space-x-2">
                          <input
                            ...
                            onChange={() => {
                              ...
                              setFormData(prev => ({ ...prev, fundingSources: updated }));
                            }}
                            className="h-4 w-4 text-green-600"
                          />
                          <span>{source}</span>
              ...
              <div className="pt-4">
                <label className="flex items-center space-x-2">
                  <input
                    ...
                    className="h-4 w-4 text-green-600"
                  />
                  <span>I certify this information is accurate and complete</span>
                </label>
              </div>
        ...
        {isSubmitted && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
              ...
              <p className="mb-4">
                Thank you! Your post-harvest investment request has been received. 
